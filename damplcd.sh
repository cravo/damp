...
import char damp_state;             /* state of DAMP, as defined below */
const char DAMP_STATE_PLAY = 0;
const char DAMP_STATE_PAUSE = 1;
const char DAMP_STATE_REW = 2;
const char DAMP_STATE_FFWD = 3;
const char DAMP_STATE_VOL_UP = 4;
const char DAMP_STATE_VOL_DOWN = 5;
